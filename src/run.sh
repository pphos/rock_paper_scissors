...
TRAIN_DATA_PATH="../datasets/training_features/data.npy"
TRAIN_TARGET_PATH="../datasets/training_features/target.npy"
TRAIN_TARGET_LABEL_PATH="../datasets/training_features/target_label.pkl"

TEST_DATA_PATH='../datasets/eval_features/data.npy'
TEST_TARGET_PATH='../datasets/eval_features/target.npy'
TEST_TARGET_LABEL_PATH='../datasets/eval_features/target_label.pkl'
